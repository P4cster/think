...
## Error
Excel hat die Möglichkeit mit einer Vielzahl von differenzierten Fehlern aufzuwarten.
...
Typisch z. B. bei Verhältniszahlen. Bedarf keinem Beispiel. Wer durch 0 teilen kann, killt die Mathematik, jeden Computer mit Prozessor, Roboter, vermutlich das gesamte Universum und kennt die Formel zur Singularität aus dem Kopf.
...
Das gleiche fragt sich dein Postbote, wenn du umgezogen bist, aber das Klingelschild noch nicht geändert hast. Gleiches Prinzip.
...
Das fragt sich dein Postbote, wenn dein Haus auf einmal weg ist.
...
Standardantwort eines Teenagers, der etwas im Haushalt suchen soll.
...
### Errorhandling
Der Vollständigkeit halber sei an dieser Stelle erwähnt, dass Excel natürlich auch ein Errorhandling eingebaut hat. Dies kann entweder in der Formel selbst, bspw. bei `XLOOKUP` oder über `ISERROR`, `IFERROR`, `ERROR.TYPE`, usw. geschehen. Dem Thema des Errorhandlings wird aber noch ein kompletter Block gewidmet.
